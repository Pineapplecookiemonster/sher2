...
const QUESTIONS = [
  {
    type: 'text',
    text: 'What should today’s main character be called?',
  ...
  {
    type: 'scale',
    text: 'On a scale of 1-10, how likely is NAME likely to run after a wild pokemon?',
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: '😵‍💫 HSK', scores: { A: 0, B: 0, C: 1, D: 3 } },
